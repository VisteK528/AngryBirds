...
Glass3x1::Glass3x1(std::shared_ptr<b2World> world, float coord_x, float coord_y, bool rotated): Box(std::move(world)) {
    this->coliding = false;
    this->destroyed = false;
    this->type.sub_type = TYPE_DATA::GLASS;

    this->t_intact.loadFromFile("textures/boxes/glass/glass_3x1.png");
    this->t_damaged.loadFromFile("textures/boxes/glass/glass_3x1_damaged.png");
    this->t_destroyed.loadFromFile("textures/boxes/glass/glass_3x1_destroyed.png");
